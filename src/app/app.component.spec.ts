...
import {MatExpansionModule,MatTableModule,MatTableDataSource} from '@angular/material';
...
describe('Component: AppComponent', () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule,MatExpansionModule,MatTableModule,MatTableDataSource
      ],
      schemas: [
